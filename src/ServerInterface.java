...
public interface ServerInterface extends Remote {
	 ...
	 * @return ACK in case of success, ACK_RSND, INVALID_TRANSACTION_ID, or
	 *         INVALID_OPERATION
	 * @throws IOException
	 * @throws RemoteException
	 */
	 ...
	 * @return ACK in case of success,INVALID_OPERATION, or
	 *         INVALID_TRANSACTION_ID for wrong txn id, or through
	 *         MessageNotFoundException calling for missing data.
	 ...
	 *            : the ID of the transaction to which this message relates
	 * @return ACK in case of success, INVALID_OPERATION, or
	 *         INVALID_TRANSACTION_ID in case of wrong txn id
	 * @throws RemoteException
	 */
